...
const privacy = () => {
  return (
    <section className=" mx-auto bg-blueGray-100  w-full h-full">
      <Layout>
        <div className="py-20 container ">
          <div className=" w-full h-full ">
            <h1 className="text-3xl text-center">Privacy Policy for DJE</h1>
            <hr />
            <div className=" text-base font-light leading-relaxed mt-0 m-2 ">
              <p>
                At DJE, accessible from dje.heroku.com, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by DJE and how we use it.
              </p>
              ...
              <p>
                ...
                information that they shared and/or collect in DJE. This policy
              ...
              <p>
                DJE follows a standard procedure of using log files. These files
              ...
              <p>
                Like any other website, DJE uses 'cookies'. These cookies are
              ...
              <p>
                ...
                the advertising partners of DJE.
              </p>

              <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on DJE, which
              ...
              <p>
                Note that DJE has no access to or control over these cookies
              ...
              <p>
                DJE's Privacy Policy does not apply to other advertisers or
              ...
              <p>
                DJE does not knowingly collect any Personal Identifiable
